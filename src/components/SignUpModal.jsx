  ...
  return (
    ...
    >
      ...
      <div className="wrap overflow-hidden rounded-3xl m-6">
        <div
          className={`box relative max-w-[42rem] w-full text-main text-wht bg-light-gra transition-all bg-main-bg/90 duration-300 rounded-3xl z-[999] py-8 px-6 sm:max-h-[600px] overflow-y-scroll sm:overflow-hidden ${
            registerModal ? "visible opacity-100" : "invisible opacity-0"
          }`}
        >
          {/* content */}
