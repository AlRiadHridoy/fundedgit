<div className="faq-nav-wrap bg-white xl:px-[56px] lg:px-[30px] py-[48px] overflow-y-scroll scrollbar-gray bg-dark">
  {/* faq */}
  <div className="faq-toggle-wrap border-[#F2F2F2] border-[1px] shadow-[0px_2.13333px_90.6667px_rgba(217,225,255,0.59)] my-2 bg-toggle shadow-[0px_2.13333px_10.6667px_rgba(217,225,255,0.59)]">
    <div className="faq-toggle-head flex items-center justify-between py-[16px] px-[32px] cursor-pointer">
      <h4 className="text-dark text-[18px] font-semibold text-wht">
        Express Rule
      </h4>
      <svg
        width="11"
        ...
        className="fill-dark fill-white"
      >
  ...
  {/* faq */}
  <div className="faq-toggle-wrap border-[#F2F2F2] border-[1px] shadow-[0px_2.13333px_90.6667px_rgba(217,225,255,0.59)] my-2 bg-toggle shadow-[0px_2.13333px_10.6667px_rgba(217,225,255,0.59)]">
    <div className="faq-toggle-head flex items-center justify-between py-[16px] px-[32px] cursor-pointer bg-toggle">
      <h4 className="text-dark text-[18px] font-semibold text-wht">
        Evaluation Rule
      </h4>
      <svg
